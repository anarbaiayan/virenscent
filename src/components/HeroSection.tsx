...
export function HeroSection() {
  return (
    <section id="hero" className="relative overflow-hidden scroll-mt-28 pt-4 sm:pt-12">
      ...
      <div className="section-shell relative">
        <div className="grid gap-8 pb-20 pt-6 sm:gap-10 sm:pb-24 sm:pt-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center lg:gap-12 lg:pb-28">
          <motion.div
            ...
            className="max-w-2xl"
          >
            <div className="mb-5 inline-flex rounded-full border border-white/50 bg-white/75 px-3 py-2 shadow-soft backdrop-blur-xl sm:mb-6 sm:px-4 sm:py-3 dark:border-white/10 dark:bg-white/5">
              <BrandLogo
                size="md"
            ...
            <h1 className="text-balance font-display text-4xl leading-[0.95] text-foreground sm:text-6xl xl:text-7xl">
              Ароматизация помещений с установкой и обслуживанием
            </h1>

            <p className="mt-5 max-w-xl text-base leading-7 text-muted-foreground sm:mt-6 sm:text-xl sm:leading-8">
              Virenscent — аренда аромаприборов для бизнеса и частных пространств в
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row">
              ...
              <a href="#aromas" className="button-secondary w-full sm:w-auto">
                Выбрать аромат
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3 text-sm text-muted-foreground">
              <span className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-line bg-white/70 px-4 py-2 text-center dark:bg-white/5 sm:w-auto">
              ...
              {heroStats.map((stat, index) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-sm font-semibold leading-6 text-foreground">{stat}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          >
            <div className="glass-panel premium-ring relative overflow-hidden p-4 sm:p-6">
              ...
              <PlaceholderMedia
                ...
                className="h-[280px] w-full rounded-[1.5rem] sm:h-[420px] sm:rounded-[1.9rem]"
              />
            </div>
